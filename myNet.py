"""
References:
    1. Github example: https://github.com/mininet/mininet/blob/master/examples/linuxrouter.py 
    2. https://stackoverflow.com/questions/46595423/mininet-how-to-create-a-topology-with-two-routers-and-their-respective-hosts 
    3. http://installfights.blogspot.com/2016/12/exception-could-not-find-default.html
    4. For controller: https://stackoverflow.com/questions/17341076/mininet-cannot-find-required-executable-controller
"""
...
class NetworkTopo(Topo):
    ...
    def build( self, **_opts ):
        ...
        self.addLink( s12, ra, intfName2="ra-eth1",
                      params2={ 'ip' : "192.168.1.1/24" } ) 
        self.addLink( s34, rb, intfName2="rb-eth1",
                      params2={ 'ip' : "172.16.0.1/12" } )
        self.addLink( s56, rc, intfName2="rc-eth1",
...
def run():
    ...
    # ra <-> rc
    net['ra'].cmd("ip route add 10.0.0.0/8 via 10.100.2.1 dev ra-eth3")
    net['rc'].cmd("ip route add 192.168.1.0/24 via 10.100.2.2 dev rc-eth2")
